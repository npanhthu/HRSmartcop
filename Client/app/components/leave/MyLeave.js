...
import columnMeta, { getNumOfDays } from '../../utils/griddle/GriddleMyLeave';
   ...
   constructor() {
    ...
    loadData() {
        ...
        EmployeeAction.getEmployee( function () {
            ...
            let employeeId = LoginStore.user.employeeId
            LeaveActions.getListAssignUser(employeeId, function () {
    ...
    getDataAssigns() {
        ...
        // _custAssigList = _.filter(_custAssigList, function(n) {
        //                                 return n % 2 == 0;
        //                         });
                    ...
                    <div className="rows">
                      ...
                      <div className="rows">  
                        <div id='showTable'>
                            ...
                            columns={ [ "employeeName","user", "leaveTypeId", "start_date", "end_date", "leaveBalance", "statusName" ]}/>
                        </div>
                    </div>
                </div>
            </div>)
